// From: https://github.com/lhandel/react-native-card-stack-swiper
...
class CardStack extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (!this._isSameChildren(this.props.children, prevProps.children)) {
      ...
      let aIndex = (this.state.topCard == 'cardA') ? this._getIndex(this.state.sindex - 2, children.length) : this._getIndex(this.state.sindex - 1, children.length);
      let bIndex = (this.state.topCard == 'cardB') ? this._getIndex(this.state.sindex - 2, children.length) : this._getIndex(this.state.sindex - 1, children.length);
      this.setState({ cards: children, cardA: children[aIndex] || null, cardB: children[bIndex] || null });
    }
  }
