        ...
        return (
            <CardFlip onFlip={logFlip} style={{ ...styles.cardContainer, height: props.height, width: props.width, shadowOpacity: props.shadowOpacity}} ref={cardRef} flipDirection="x" duration={400} {...props}>
                <TouchableOpacity activeOpacity={1} onPress={() => cardRef.current.flip()}>
                    <Image source={{ uri: props.card.front }} style={{height: props.height, borderRadius: 10 }}  resizeMode="stretch"/>
                </TouchableOpacity>

                <TouchableOpacity activeOpacity={1} onPress={() => cardRef.current.flip()}>
                    <Image source={{ uri: props.card.back }} style={{height: props.height, borderRadius: 10 }}  resizeMode="stretch"/>
                </TouchableOpacity>
            </CardFlip>
        );
};
